/* Verilog netlist generated by SCUBA Diamond (64-bit) 3.11.3.469.0 */
/* Module Version: 5.7 */
/* /usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n pll -lang verilog -synth lse -arch xo3c00a -type pll -fin 133 -fclkop 25.175 -fclkop_tol 1.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 5 -lock -fracn 624  */
...
module pll (CLKI, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam PLLInst_0.FRACN_DIV = 624 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKFB_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="24.937500" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 24.937500
