...
/* Module Version: 5.7 */
/* /usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n pll -lang verilog -synth lse -arch xo3c00a -type pll -fin 12 -mdiv 1 -ndiv 2 -trimp 0 -phasep 0 -trimp_r -adiv 22 -phase_cntl STATIC -fb_mode 1 -lock -fracn 6418  */
...
module pll (CLKI, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam PLLInst_0.FRACN_DIV = 6418 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="25.175171" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 25.175171
